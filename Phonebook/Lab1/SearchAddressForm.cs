...
namespace Lab1
{
    public partial class SearchAddressForm : Form
    {
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            {
                string a = Convert.ToString(MyRecord.House);
                string b =Convert.ToString(MyRecord.Flat);
                if ((a == NameTextBox.Text) &&
               MyRecord.Street.Contains(LastNameTextBox.Text) && (b == PatronymicTextBox.Text))
                {
